...
void followLine(int s1, int s2, int s3, int s4, int s5) {
  ...
  {
    changeSpeed(150);
    moveForDistance(215, "moveLeftForward");
    //delay(100);
  ...
  // {
  //   changeSpeed(150);
  //   moveForDistance(240, "moveRightForward");
  //   // delay(100);
  //   moveForDistance(27, "turnRightFrontCenterICC");
  //   // delay(100);
  //   moveForDistance(100, "moveForward");
  //   delay(50000);
  // }
